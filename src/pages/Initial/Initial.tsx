...
import { Flex, Text, Heading, Button, Image, Box } from '@chakra-ui/react';
...
const Initial = () => {
  ...
  return (
    <Box>
      <Navbar /> 
      <Flex px={12} py={8} direction='column'>
      <Box
        bgImage={`url(${products[selectedProduct].background})`}
        bgSize="cover"
        bgPosition="center"
        bgRepeat="no-repeat"
          ...
          <Flex justifyContent="space-between" w="100%" alignItems="center">
            <Flex direction="column" gap="4">
              <Flex alignContent="start" justifyContent="start" direction="column">
                <Heading fontSize="7xl" color="white" mb="4" fontWeight="300" letterSpacing="0.35rem">
                  Find your
                </Heading>
                <Heading fontSize="7xl" color="white" mb="4" fontWeight="300" letterSpacing="0.35rem" width="800px">
                  perfect Foundation!
                </Heading>
              </Flex>
              <Flex mb="4">
